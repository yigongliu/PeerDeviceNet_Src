...
public class DecoderActivity extends Activity implements SurfaceHolder.Callback {
	...
	public void handleDecodeInternally(Result rawResult, Bitmap barcode) {
		...
		Toast toast = Toast.makeText(this.getApplicationContext(),
				"Scanned code: " + rawResult.getText(), Toast.LENGTH_SHORT);
		toast.show();
	*/
		//restartPreviewAfterDelay(3000);
		Intent i = new Intent("RETURN_DECODE_RESULT");
		i.putExtra("DecodeResult", rawResult.getText());
